"""Pure FedAvg client 1 for the alpha=0.1 equal-size split."""
import json
import random
import sys
...
# Change only this value in the separate clients 2 through 5.
CLIENT_ID = 1

DATA_PATH = rf"D:\CAPSTONE\Dir7EqualA01_Client{CLIENT_ID}.csv"
...
if len(sys.argv) < 2:
    raise ValueError("Usage: python client1_a01_fedavg.py <port>")
