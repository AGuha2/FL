...
# ── SHAP setup: background + a FIXED sample (drawn once, reused every round) ──
...
fixed_sample_idx = np.random.choice(x_train.shape[0], fixed_sample_size, replace=False)
x_sample = x_train[fixed_sample_idx]
