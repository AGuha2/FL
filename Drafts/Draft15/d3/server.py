...
RESULT_DIR = Path("results_10round_7class_equal_fedavg")
...
class BaselineFedAvg(fl.server.strategy.FedAvg):
    """Uses Flower's standard num_examples-weighted FedAvg aggregation."""
