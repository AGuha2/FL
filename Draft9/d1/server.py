...
def compute_SHAP_weights(all_shap, feature_names, num_examples, shap_influence=0.5):
...
class SaveModelStrategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        SW = compute_SHAP_weights(all_shap, feature_names, num_examples, shap_influence=0.5)
