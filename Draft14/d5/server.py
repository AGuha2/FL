...
SHAP_INFLUENCE = 0.50
SEED = 42
SERVER_DATA_PATH = r"D:\CAPSTONE\Server_Test_Class.csv"
SCALER_PATH = r"D:\CAPSTONE\global_scaler_Class.pkl"
RESULT_DIR = Path("results_10round_classaware_stratified")
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        for class_index, class_name in enumerate(ALL_LABELS):
            ...
            if present_mask.sum() == 0:
                ...
                class_shap_weights = normalized(
                    shap_weights * present_mask
                )
            ...
            for record, class_weight in zip(records, class_weights):
